...
<head>
    ...
    <!-- Favicon -->
    <link href="{{url('storage/app/uploads' . Auth::user()->image)}}" rel="icon">
            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="{{url('storage/app/uploads' . Auth::user()->image)}}" alt="" style="width: 40px; height: 40px;">
